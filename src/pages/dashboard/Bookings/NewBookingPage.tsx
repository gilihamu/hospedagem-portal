                        ...
                        >
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-1.5">
                              ...
                              {g.isVip && <span className="text-[10px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded-full font-medium">VIP</span>}
                              {g.totalStays > 0 && <span className="text-[10px] text-neutral-400">{g.totalStays}x</span>}
                            </div>
                            <p className="text-xs text-neutral-400 truncate">{g.email}{g.phone ? ` · ${g.phone}` : ''}</p>
                          </div>
                        </button>
                      ))
                    ) : !searchLoading ? (
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Cadastrar Novo Hóspede" size="md">
      <form onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-4">
        <p className="text-sm text-neutral-500 -mt-2 mb-2">
          O hóspede será cadastrado na base e vinculado ao seu estabelecimento.
        </p>
