...
export interface SaveGuestData {
  firstName: string;
  lastName: string;
  email?: string;
  phone?: string;
...
export interface NationalityDist {
  nationality: string;
  count: number;
  percentage: number;
}

export interface MonthlyGuestCount {
  month: string;
  count: number;
}
...
export interface GuestAnalytics {
  ...
  monthlyNewGuests: MonthlyGuestCount[];
}
...
export type SaveFnrhData = Omit<FnrhRecord, 'id' | 'status' | 'hasSignature' | 'signedAt' | 'sentAt' | 'createdAt'>;
