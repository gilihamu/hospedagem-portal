...
const DashboardBookingManage = lazy(() => import('../pages/dashboard/Bookings/BookingManagePage').then(m => ({ default: m.BookingManagePage })));
const DashboardImportBooking = lazy(() => import('../pages/dashboard/ImportBookingCom').then(m => ({ default: m.ImportBookingComPage })));
...
const DashboardFinance = lazy(() => import('../pages/dashboard/Finance').then(m => ({ default: m.FinanceDashboardPage })));
const DashboardFinanceExpenses = lazy(() => import('../pages/dashboard/Finance/ExpensesPage').then(m => ({ default: m.ExpensesPage })));
const DashboardFinanceCashFlow = lazy(() => import('../pages/dashboard/Finance/CashFlowPage').then(m => ({ default: m.CashFlowPage })));
const DashboardFinanceReports = lazy(() => import('../pages/dashboard/Finance/ReportsPage').then(m => ({ default: m.ReportsPage })));
...
const DashboardGuests = lazy(() => import('../pages/dashboard/Guests').then(m => ({ default: m.GuestsPage })));
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: ROUTES.DASHBOARD_BOOKING_MANAGE, element: withSuspense(DashboardBookingManage) },
              { path: ROUTES.DASHBOARD_IMPORT_BOOKING, element: withSuspense(DashboardImportBooking) },
              ...
              { path: ROUTES.DASHBOARD_GUESTS, element: withSuspense(DashboardGuests) },
              { path: ROUTES.DASHBOARD_PROFILE, element: withSuspense(DashboardProfile) },
              { path: ROUTES.DASHBOARD_FINANCE, element: withSuspense(DashboardFinance) },
